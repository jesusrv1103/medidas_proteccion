						...
						<div class="kt-login__container">
							...
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Bienvenido  al  SMP</h3>
								</div>
								<form class="kt-form" role="form" method="POST" action="{{ route('login') }}">
                                        @csrf
									<div class="input-group">
                                        <input class="form-control @error('user_name') is-invalid @enderror" required type="text" placeholder="Nombre de Usuario" name="user_name" autocomplete="user_name" />
                                        @error('user_name')
